...
export const Login = () => {
    return (
        <div>
            <header className=" p-2 border-b border-red-300">
                <div className="container max-w-3xl flex justify-center">
                    <img src="/imgs/logo-p.svg" className="w-32 md:w-40"></img>
                </div>
            </header>
            ...
            <main className="container max-w-xl p-4">
                ...
                <form className="space-y-6">
                    ...
                    <button className="w-full text-center text-white bg-red-500 text-xl px-6 py-4 rounded-xl">
                        Criar minha conta
                    </button>
